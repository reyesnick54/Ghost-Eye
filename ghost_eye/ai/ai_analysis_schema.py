...
class AIAnalysisConfig:
    ...
    def from_env(cls, env: Mapping[str, str] | None = None) -> "AIAnalysisConfig":
        ...
        return cls(
            enabled=parse_bool(source.get("GHOSTEYE_AI_ANALYSIS", DEFAULT_AI_ANALYSIS), default=True),
            provider=provider,
...
class AIAnalysisResult:
    """Serializable deterministic/advisory analysis result."""
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        payload = asdict(self)
        payload["false_positive_risks"] = list(self.false_positive_risks)
